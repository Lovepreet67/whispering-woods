...
pub mod peer_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> PeerClient<InterceptedService<T, F>>
        where
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/datanode_datanode.Peer/CreatePipeline",
            );
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/datanode_datanode.Peer/StoreChunk",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("datanode_datanode.Peer", "StoreChunk"));
            self.inner.unary(req, path, codec).await
        }
...
pub mod peer_server {
    ...
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with PeerServer.
    #[async_trait]
    pub trait Peer: std::marker::Send + std::marker::Sync + 'static {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/datanode_datanode.Peer/CreatePipeline" => {
                    ...
                    struct CreatePipelineSvc<T: Peer>(pub Arc<T>);
                    impl<
                        T: Peer,
                    ...
                    for CreatePipelineSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as Peer>::create_pipeline(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/datanode_datanode.Peer/StoreChunk" => {
                    #[allow(non_camel_case_types)]
                    struct StoreChunkSvc<T: Peer>(pub Arc<T>);
                    impl<T: Peer> tonic::server::UnaryService<super::StoreChunkRequest>
                    for StoreChunkSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Peer>::store_chunk(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "datanode_datanode.Peer";
    impl<T> tonic::server::NamedService for PeerServer<T> {
