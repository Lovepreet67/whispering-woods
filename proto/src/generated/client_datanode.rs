...
pub mod client_data_node_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/client_datanode.ClientDataNode/CommitChunk",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("client_datanode.ClientDataNode", "CommitChunk"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn fetch_chunk(
            &mut self,
            request: impl tonic::IntoRequest<super::FetchChunkRequest>,
        ) -> std::result::Result<
            tonic::Response<super::FetchChunkResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/client_datanode.ClientDataNode/FetchChunk",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("client_datanode.ClientDataNode", "FetchChunk"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod client_data_node_server {
    ...
    pub trait ClientDataNode: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn fetch_chunk(
            &self,
            request: tonic::Request<super::FetchChunkRequest>,
        ) -> std::result::Result<
            tonic::Response<super::FetchChunkResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/client_datanode.ClientDataNode/CommitChunk" => {
                    #[allow(non_camel_case_types)]
                    struct CommitChunkSvc<T: ClientDataNode>(pub Arc<T>);
                    impl<
                        T: ClientDataNode,
                    > tonic::server::UnaryService<super::CommitChunkRequest>
                    for CommitChunkSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ClientDataNode>::commit_chunk(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/client_datanode.ClientDataNode/FetchChunk" => {
                    #[allow(non_camel_case_types)]
                    struct FetchChunkSvc<T: ClientDataNode>(pub Arc<T>);
                    impl<
                        T: ClientDataNode,
                    > tonic::server::UnaryService<super::FetchChunkRequest>
                    for FetchChunkSvc<T> {
                        type Response = super::FetchChunkResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ClientDataNode>::fetch_chunk(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = FetchChunkSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
